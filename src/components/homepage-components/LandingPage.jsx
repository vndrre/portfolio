...
const LandingPage = () => {
  ...
  const isInView = useInView(ref, { once: true }); // Trigger the animation once when in view
    ...
    <div>
      <div ref={ref} className="lg:grid lg:place-items-center md:hidden hidden">
        ...
        >
          ...
          <img src="/src/assets/landing-image.png" alt="" className="absolute top-0 left-0 opacity-5 h-[800px] w-full hidden"/>
        </motion.div>
      </div>

      <div className='text-center block md:block lg:hidden'>
        <div className='grid grid-cols-1 gap-3 mt-[265px]'>
          <h1 className='text-5xl md:text-6xl'> Web Designer <br /> <span className='italic'> & Developer </span> </h1>
          <p className='text-[15px] md:text-xl'> Web design and devlopment <br /> services to help your business stand out </p>
        </div>
      </div>
